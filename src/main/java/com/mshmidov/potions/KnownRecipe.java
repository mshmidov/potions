...
public enum KnownRecipe implements Recipe {
    ...
    LOVE_POTION(new ComplexRecipe("Любовное зелье",
            SimpleRecipe.forVerb(Verb.INDUCE).named("Любовное зелье")
                    ...
                    .onRound(5).finish(),
            SimpleRecipe.forVerb(Verb.BIND).named("Любовное зелье")
                    .onRound(1).add(Ingredient.LOVAGE_FLOWERS.asIs())
    ...
    INDIFFERENCE_POTION(new ComplexRecipe("Отворотное зелье",
            SimpleRecipe.forVerb(Verb.INDUCE).named("Отворотное зелье")
                    ...
                    .onRound(5).finish(),
            SimpleRecipe.forVerb(Verb.DAMAGE).named("Отворотное зелье")
    ...
    LIVING_DEATH_DRAUGHT(new ComplexRecipe("Напиток живой смерти",
            SimpleRecipe.forVerb(Verb.INDUCE)
    ...
    VIGOR_POTION(new ComplexRecipe("Ободряющее зелье",
            SimpleRecipe.forVerb(Verb.INDUCE)
                    ...
                    .onRound(6).finish(),
            SimpleRecipe.forVerb(Verb.DECREASE)
                    .named("Ободряющее зелье")
                    .onRound(1).add(Ingredient.SOPOPHORA_BEAN.asIs(), Ingredient.SOPOPHORA_BEAN.asIs())
